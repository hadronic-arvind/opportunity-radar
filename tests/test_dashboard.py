...
class DashboardTests(unittest.TestCase):
    ...
    def test_dashboard_uses_structured_dates_matches_and_contrast_safe_tokens(self):
        ...
        self.assertIn('grid-template-columns: minmax(0, 1fr) 315px', styles)
        ...
        self.assertIn('"STEM coverage preset"', script)
    ...
    def test_profile_editor_is_hybrid_bounded_and_native_only_for_writes(self):
        ...
        self.assertIn("fields.append(basics, sourcesPage, advanced)", script)
        self.assertIn("function profileDegreesField(", script)
        self.assertIn("function profileSourceField(", script)
        self.assertIn("data-profile-pending-input", script)
        ...
        self.assertIn('data-profile-page-tab="sources"', template)
        self.assertIn('data-profile-page-tab="advanced"', template)
        self.assertIn('id="profile-import-dialog"', template)
